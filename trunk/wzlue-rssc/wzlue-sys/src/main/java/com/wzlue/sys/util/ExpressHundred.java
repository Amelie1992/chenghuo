...
/**
 * 授权key：gmKOvaLO1654
 * customer ：6E9A647BEDE0D28ED647B1AEB112260F
 * yunda
 * 3836181821097
 */
public class ExpressHundred{
	...
	public static void main(String[] args) {
		String key = "gmKOvaLO1654";				//贵司的授权key
		String customer = "6E9A647BEDE0D28ED647B1AEB112260F";			//贵司的查询公司编号
		String com = "";			//快递公司编码
		String num = "";	//快递单号
		...
		ExpressHundred demo = new ExpressHundred(key, customer);
	...
	private String key = "gmKOvaLO1654";			//授权key
	private String customer = "6E9A647BEDE0D28ED647B1AEB112260F";	//实时查询公司编号

	public ExpressHundred(String key, String customer) {
		this.key = key;
	...
	public String synQueryData(String com, String num, String phone, String from, String to, int resultv2) {
		...
		String sign = MD5.encode(param + this.key + this.customer);
	...
	public static String getSynquery(String com, String num){
		String key = "gmKOvaLO1654";				//贵司的授权key
		String customer = "6E9A647BEDE0D28ED647B1AEB112260F";			//贵司的查询公司编号
		String phone = "";				//手机号码后四位
		String from = "";				//出发地
