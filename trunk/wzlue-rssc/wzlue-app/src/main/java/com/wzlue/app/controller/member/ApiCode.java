...
import com.wzlue.app.controller.common.JunitImage;
...
//    生成带参的二维码
    ...
    public R code(Long userId) throws Exception {
        ...
        String url=junitImage.markImageByText("/home/file/1.png","/home/file/fileupload/erweima/" + uuidNew+".png",0,"png",scenStr,accesstoken,uuidNew);
        return R.ok().put("getQRCode",url);
