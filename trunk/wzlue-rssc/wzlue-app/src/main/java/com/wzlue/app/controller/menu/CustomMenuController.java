...
public class CustomMenuController {
	...
	public R list(@RequestParam Map<String, Object> params){
		...
		for (CustomMenuEntity menu:customMenuList) {
		    menu.setBody(null);
        }
...
//	@RequiresPermissions("menu:custommenu:info")
	public R info(@PathVariable("id") Long id){
		...
		customMenu.setId(null);
		customMenu.setState(null);
		customMenu.setClassification(null);
		customMenu.setCreateTime(null);
		customMenu.setUpdateTime(null);
