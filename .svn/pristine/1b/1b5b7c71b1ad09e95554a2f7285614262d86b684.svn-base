...
public class OrderRefundEntity implements Serializable {
	...
	//退货物流
	private RefundLogisticsEntity refundLogisticsEntity;
	...
	public RefundLogisticsEntity getRefundLogisticsEntity() {
		return refundLogisticsEntity;
	}

	public void setRefundLogisticsEntity(RefundLogisticsEntity refundLogisticsEntity) {
		this.refundLogisticsEntity = refundLogisticsEntity;
	}
	...
	public OrderGoodsEntity getOrderGoodsEntity() {
		return orderGoodsEntity;
	}

	public void setOrderGoodsEntity(OrderGoodsEntity orderGoodsEntity) {
